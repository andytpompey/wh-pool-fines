...
3. Run `supabase/tests/commercial_production_readiness.sql` in the target project.
...
9. Run `supabase/tests/commercial_production_readiness.sql` again. Both arrays must
   be empty.
